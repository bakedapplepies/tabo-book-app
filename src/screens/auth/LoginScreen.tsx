...
const LoginScreen = () => {
  return (
    <View style={styles.container}>
      ...
      <TextInput
        placeholder="Email" style={styles.input_field}
      ...
      <TouchableOpacity style={{ ...styles.sign_button, backgroundColor: "white" }}>
        <Text style={{ ...styles.sign_text, color: "#F58216" }}>Sign up</Text>
      </TouchableOpacity>
    </View>
  )
}
